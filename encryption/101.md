...
We did a few cool thing in this article, learning a few clever-guy- words along the way. Let's recap what we did exactly using a clever-guy-language:

1. Created a **binary** to text **fixed-length encoding** with help of **padding**, analogues to **ASCII**.
...
*. Learned that encoding **chars** include various things from **control characters** to emojis. 

So for the AI takeover it gives us at least the basics of computers "language" 😉.
